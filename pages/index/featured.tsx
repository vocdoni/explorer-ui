      ...
      <BlockContainer>
        <CuttingEdgeFeaturesContainer>
          <ImageContainer width="96px">
            <img src="/images/anonymous.png" alt={t('featured.anonymous_image_alt')} />
          </ImageContainer>
          <ImageContainer width="110px">
            <img src="/images/open-source.png" alt={t('featured.open_source_image_alt')} />
          </ImageContainer>
          <ImageContainer width="84px">
            <img src="/images/scalable.png" alt={t('featured.scalable_image_alt')} />
          </ImageContainer>
          <ImageContainer width="98px">
            <img src="/images/inexpensive.png" alt={t('featured.inexpensive_image_alt')} />
          </ImageContainer>
          <ImageContainer width="70px">
            <img src="/images/censorship_subtitle.png" alt={t('featured.censorship_image_alt')} />
          </ImageContainer>
          <ImageContainer width="100px">
            <img src="/images/verifiable.png" alt={t('featured.verifiable_image_alt')} />
          </ImageContainer>
        </CuttingEdgeFeaturesContainer>
      </BlockContainer>
          ...
          <Grid>
            <Column sm={12} md={6}>
              ...
              <Typography variant={TypographyVariant.Small}>
                {t('featured.a_fully_anonymous_voting_system_ensuring_data_availability')}
              </Typography>
              <Typography variant={TypographyVariant.Small}>
                {t('featured.leveraging_on_decentalized_technologies')}
              </Typography>
              <HomePageButton>
                <Link href={process.env.PLAZA_URL}>{t('featured.know_more')}</Link>
              </HomePageButton>
            </Column>
            <Column sm={12} md={6}>
              <ImageContainer width="400px" alignItem={FlexAlignItem.Center}>
                <img src="/images/edge-protocol.png" alt={t('featured.edge_protocol_image_alt')} />
              </ImageContainer>
            </Column>
          </Grid>
        </CenteredBlockContainer>
