...
import { MapQuestionError, InvalidQuestionsError, QuestionError } from './errors/invalid-question-error';
...
export const questionsValidator = (questions: Question[]): InvalidQuestionsError => {
