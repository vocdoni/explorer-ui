...
export const Paginator = ({
  ...
  const InnerButtonsDesktop = () => (
    <>
      ...
      {currentPage !== 1 && currentPage !== totalPageCount && <NumberButton page={currentPage} />}

      {currentPage < totalPageCount - 1 && <NumberButton page={currentPage + 1} />}
      ...
      {currentPage !== totalPageCount && (
        <Button small disabled={currentPage === totalPageCount} onClick={() => paginate(currentPage + 1)}>
          <FakedButton>
            <BiChevronRight />
          </FakedButton>
        </Button>
  ...
  return (
    <PaginatorContainer>
      <GroupButtonMargin>
        <Button small disabled={currentPage === 1} onClick={() => paginate(currentPage - 1)}>
          <FakedButton>
            <BiChevronLeft />
          </FakedButton>
        </Button>
